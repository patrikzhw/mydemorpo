function hellosg(){
  ...
  $stats && $stats({moduleName:'hellosg', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'begin'});
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      var iframe = $doc_0.getElementById('hellosg');
      ...
      hellosg = null;
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'hellosg', base, softPermutationId);
      $stats && $stats({moduleName:'hellosg', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'end'});
    }
  }
  ...
  function computeScriptBase(){
    ...
    function tryNocacheJsTag(){
      ...
      for (var i = 0; i < scriptTags.length; ++i) {
        if (scriptTags[i].src.indexOf('hellosg.nocache.js') != -1) {
    ...
    function tryMarkerScript(){
      ...
      if (typeof isBodyLoaded == 'undefined' || !isBodyLoaded()) {
        var markerId = '__gwt_marker_hellosg';
        var markerScript;
  ...
  function maybeInjectFrame(){
    if (!frameInjected) {
      ...
      $stats && $stats({moduleName:'hellosg', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'moduleRequested'});
  ...
  ;
  hellosg.onInjectionDone = function(){
    scriptsDone = true;
    $stats && $stats({moduleName:'hellosg', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'end'});
    maybeStartModule();
  }
  ;
  processMetas();
  ...
  var initialHtml;
  if (isHostedMode()) {
    if ($wnd_0.external && ($wnd_0.external.initModule && $wnd_0.external.initModule('hellosg'))) {
      $wnd_0.location.reload();
      return;
    }
    initialHtml = 'hosted.html?hellosg';
    strongName = '';
  }
  $stats && $stats({moduleName:'hellosg', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'selectingPermutation'});
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['ie6'], '0D9386510D74916A94388FFF3ED2609A');
      unflattenKeylistIntoAnswers(['ie8'], '50929096C0496A408BAE927F723D876C');
      unflattenKeylistIntoAnswers(['gecko1_8'], '836BC3FC4E0ED56BAFD1AFF43613109E');
      unflattenKeylistIntoAnswers(['ie9'], 'C8DABC7CAB524E033773FB9D3074E8FC');
      unflattenKeylistIntoAnswers(['safari'], 'D919F9B9B0256644D287B7D4C5D279A2');
      unflattenKeylistIntoAnswers(['opera'], 'FF5511814C066206CE0D6FF4F97E0D3E');
  ...
  , 50);
  $stats && $stats({moduleName:'hellosg', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'end'});
  $stats && $stats({moduleName:'hellosg', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'begin'});
  ...
  $doc_0.write('<script defer="defer">hellosg.onInjectionDone(\'hellosg\')<\/script>');
}
